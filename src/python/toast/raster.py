...
class Raster:
  ...
  def Basis2Sol(self):
    """
      Returns a vector of length Blen() (basis dimension). Each entry contains the index of
      the corresponding element in the solution vector (range 0 .. Slen()-1), or -1 if the
