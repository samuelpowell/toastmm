...
class RASTERLIB Solution;

RASTERLIB double l2norm (const Solution &sol);
RASTERLIB Solution exp (const Solution &sol);
RASTERLIB Solution log (const Solution &sol);
...
public:
    ...
    friend RASTERLIB double l2norm (const Solution &sol);
    friend RASTERLIB Solution exp (const Solution &sol);
    friend RASTERLIB Solution log (const Solution &sol);
